        ...
        return (
            <div className='max-w-sm min-w-[24rem] space-y-3 select-none hover:scale-110 duration-300'>
                <div className='relative w-full'>
                    ...
                    <Image width={1000} height={1000} src={singleProductData?.image[0] ? urlFor(singleProductData?.image[0]).width(1000).height(1000).url() : "/logo.webp"} alt={singleProductData.image[0].alt} />
                </div>
