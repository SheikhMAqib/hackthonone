        ...
        <div className="py-5 flex items-center justify-between px-2">
            ...
            <div className="space-y-6 max-w-sm ">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-14 md:w-28">
                        <Image width={90} height={90} src={"https://full-stack-ecommerce-clothing-web.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FFeatured2.247cd605.png&w=128&q=75"} alt="bustle" />
                    </div>
                    <div className="w-14 md:w-28">
