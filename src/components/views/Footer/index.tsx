        ...
        <footer className="text-gray-500 body-font">
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 SheikhMAqib —
                        <a href="https://twitter.com/SheikhMAqib" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@SheikhMAqib</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        ...
                        <Link href={"https://github.com/SheikhMAqib"} className="w-5 h-5 ml-3 text-gray-500">
