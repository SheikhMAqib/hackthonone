                                ...
                                <div className=" space-y-1 md:space-y-3 w-full ">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <div className="flex gap-2 items-center text lg">
                                            <div className="select-none cursor-pointer flex justify-center w-7 h-7 rounded-full bg-gray-200">-</div>
                                            <p>5</p>
                                            <div className="select-none cursor-pointer flex justify-center w-7 h-7 rounded-full  border-gray-800">+</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
